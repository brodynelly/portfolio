      ...
      <div className="container max-w-5xl mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          >
            <ScrollToTopLink
              to="/projects"
              className="px-8 py-3 bg-primary text-primary-foreground rounded-md font-medium transition-all hover:translate-y-[-2px] hover:shadow-lg inline-block text-center"
            >
              View Projects
            </ScrollToTopLink>
            <a
